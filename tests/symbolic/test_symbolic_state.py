...
class TestSymbolicVariable:
    ...
    def test_symbolic_variable_unsupported_sort_raises(self):
        ...
        # [20251227_BUGFIX] Use ArraySort instead of RealSort (Real is now supported)
        from z3 import ArraySort, IntSort

        with pytest.raises(ValueError, match="Unsupported sort"):
            SymbolicVariable("arr", ArraySort(IntSort(), IntSort()))
...
class TestCoverageCompleteness:
    ...
    def test_create_variable_unsupported_sort_raises(self):
        ...
        with pytest.raises(ValueError, match="Unsupported sort"):
            state.create_variable("arr", ArraySort(IntSort(), IntSort()))
