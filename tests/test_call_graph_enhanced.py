...
''')
    ...
    def test_edges_capture_calls(self, simple_project):
        ...
        main_to_helper = [e for e in result.edges 
                         if "main" in e.caller and "helper" in e.callee]
    ...
    def test_entry_point_filtering(self, simple_project):
        ...
        # Get all nodes
        result_all = builder.build_with_details()
...
'''
        ...
        factorial_edges = [e for e in result.edges 
