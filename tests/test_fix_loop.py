...
class TestFixLoopTermination:
    ...
    def test_terminates_after_max_attempts(self):
        ...
        sandbox.execute_with_changes.side_effect = [
            SandboxResult(
                success=False, all_passed=False, stdout="",
                stderr="Error 1", execution_time_ms=100
            ),
            SandboxResult(
                success=False, all_passed=False, stdout="",
                stderr="Error 2", execution_time_ms=100
            ),
            SandboxResult(
                success=False, all_passed=False, stdout="",
                stderr="Error 3", execution_time_ms=100
            ),
        ]
...
class TestFixLoopAuditTrail:
    ...
    def test_includes_timing_information(self):
        ...
        sandbox.execute_with_changes.side_effect = [
            SandboxResult(
                success=False, all_passed=False, stdout="",
                stderr="Error 1", execution_time_ms=150
            ),
            SandboxResult(
                success=False, all_passed=False, stdout="",
                stderr="Error 2", execution_time_ms=150
            ),
        ]
