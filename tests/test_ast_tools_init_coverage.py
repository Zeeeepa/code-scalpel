...
def test_transformer_validator_utils_fallback_none(monkeypatch):
    ...
    optional_attrs = ["ASTTransformer", "ASTValidator", "is_constant", "get_node_type", "get_all_names"]
...
def test_import_info_type_symbol_definition_circular_import_graph_fallback():
    ...
    import_related = ["ImportInfo", "ImportType", "SymbolDefinition", "CircularImport", "ImportGraphResult"]
