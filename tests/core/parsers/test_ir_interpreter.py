...
"""
    ...
    def test_if_with_unevaluable_condition(self):
        ...
        from code_scalpel.ir.nodes import IRAssign, IRCall, IRConstant, IRName
...
"""
    ...
    def test_eval_unknown_expression_type(self):
        ...
        from code_scalpel.ir.nodes import IRAssign, IRExpr, IRName
    ...
    def test_eval_bool_op_empty_values(self):
        ...
        from code_scalpel.ir.nodes import IRAssign, IRBoolOp, IRName
    ...
    def test_aug_assign_unknown_operator(self):
        ...
        from code_scalpel.ir.nodes import IRAugAssign, IRConstant, IRName
        from code_scalpel.ir.operators import AugAssignOperator
...
"""
    ...
    def test_assignment_creates_placeholder_for_unknown(self):
        ...
        from code_scalpel.ir.nodes import IRAssign, IRCall, IRName
