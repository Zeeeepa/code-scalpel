...
from code_scalpel.graph_engine.graph import (GraphBuilder, GraphEdge,
                                             GraphNode, UniversalGraph)
from code_scalpel.graph_engine.node_id import \
    create_node_id  # [20240613_REFACTOR] Remove unused imports UniversalNodeID, NodeType per CodeQL warning
