...
def mock_community_license(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("SCALPEL_LICENSE_JWT", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aWVyIjoiY29tbXVuaXR5In0.test")


@pytest.fixture
def mock_pro_license(monkeypatch: pytest.MonkeyPatch) -> None:
    """Mock a Pro tier license."""
    monkeypatch.setenv("SCALPEL_LICENSE_JWT", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aWVyIjoicHJvIn0.test")


@pytest.fixture
def mock_enterprise_license(monkeypatch: pytest.MonkeyPatch) -> None:
    """Mock an Enterprise tier license."""
    monkeypatch.setenv("SCALPEL_LICENSE_JWT", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aWVyIjoiZW50ZXJwcmlzZSJ9.test")
...
def mock_expired_license(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("SCALPEL_LICENSE_JWT", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aWVyIjoicHJvIiwiZXhwIjoxNTc3ODM2ODAwfQ.test")
