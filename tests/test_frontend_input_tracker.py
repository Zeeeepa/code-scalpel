...
class TestVanillaInputDetection:
    ...
    def test_event_target_value(self):
        ...
        event_sources = [s for s in result.input_sources 
    ...
    def test_location_search(self):
        ...
        url_sources = [s for s in result.input_sources 
    ...
    def test_local_storage(self):
        ...
        storage_sources = [s for s in result.input_sources 
                          if s.source_type in (InputSourceType.LOCAL_STORAGE, 
                                               InputSourceType.SESSION_STORAGE)]
...
class TestReactInputDetection:
    ...
    def test_use_ref(self):
        ...
        ref_sources = [s for s in result.input_sources 
    ...
    def test_on_change_handler(self):
        ...
        form_sources = [s for s in result.input_sources 
...
class TestVueInputDetection:
    ...
    def test_v_model(self):
        ...
        v_model_sources = [s for s in result.input_sources 
    ...
    def test_vue_ref(self):
        ...
        ref_sources = [s for s in result.input_sources 
                      if s.source_type == InputSourceType.VUE_REF]
...
class TestAngularInputDetection:
    ...
    def test_ng_model(self):
        ...
        ng_model_sources = [s for s in result.input_sources 
    ...
    def test_input_decorator(self):
        ...
        input_sources = [s for s in result.input_sources 
...
class TestDangerousSinkDetection:
    ...
    def test_inner_html(self):
        ...
        html_sinks = [s for s in result.dangerous_sinks 
                     if s.sink_type in (DangerousSinkType.INNER_HTML, 
                                        DangerousSinkType.DOM_MANIPULATION)]
    ...
    def test_document_write(self):
        ...
        write_sinks = [s for s in result.dangerous_sinks 
    ...
    def test_react_dangerously_set_inner_html(self):
        ...
        dangerous_sinks = [s for s in result.dangerous_sinks 
    ...
    def test_vue_v_html(self):
        ...
        v_html_sinks = [s for s in result.dangerous_sinks 
                       if s.sink_type == DangerousSinkType.V_HTML]
    ...
    def test_angular_inner_html_binding(self):
        ...
        assert any(s.sink_type == DangerousSinkType.INNER_HTML_BINDING 
    ...
    def test_eval(self):
        ...
        eval_sinks = [s for s in result.dangerous_sinks 
                     if s.sink_type == DangerousSinkType.EVAL]
    ...
    def test_location_redirect(self):
        ...
        redirect_sinks = [s for s in result.dangerous_sinks 
                         if s.sink_type in (DangerousSinkType.LOCATION, 
                                            DangerousSinkType.OPEN)]
...
class TestDataFlowAnalysis:
    ...
    def test_direct_flow_to_inner_html(self):
        ...
        assert any(f.sink.sink_type == DangerousSinkType.INNER_HTML 
    ...
    def test_react_state_to_dangerous_html(self):
        ...
        assert any(f.sink.sink_type == DangerousSinkType.DANGEROUSLY_SET 
                  for f in dangerous)
...
class TestSanitizationDetection:
    ...
    def test_text_content_safe(self):
        ...
        dangerous_html = [s for s in result.dangerous_sinks 
