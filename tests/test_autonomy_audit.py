...
from code_scalpel.autonomy import AuditEntry, AutonomyAuditTrail
...
class TestFiltering:
    ...
    def test_filter_by_time_range(self, audit_trail):
        ...
        json_output = audit_trail.export(
            format="json",
            time_range=(mid_time, datetime.now() + timedelta(seconds=1))
        )
