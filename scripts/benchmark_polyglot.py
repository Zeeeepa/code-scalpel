...
def benchmark_extraction(code: str, file_path: str, language: Language, 
                         target_type: str, target_name: str, iterations: int = 10) -> dict:
...
def main():
    ...
    print(f"Java:       min={java_parse['min_ms']:.2f}ms  avg={java_parse['avg_ms']:.2f}ms  max={java_parse['max_ms']:.2f}ms")
    ...
    print(f"Python function:     min={py_ext['min_ms']:.2f}ms  avg={py_ext['avg_ms']:.2f}ms  success={py_ext['success']}")
    ...
    print(f"Python class:        min={py_cls['min_ms']:.2f}ms  avg={py_cls['avg_ms']:.2f}ms  success={py_cls['success']}")
    ...
    print(f"JavaScript function: min={js_ext['min_ms']:.2f}ms  avg={js_ext['avg_ms']:.2f}ms  success={js_ext['success']}")
    ...
    print(f"JavaScript class:    min={js_cls['min_ms']:.2f}ms  avg={js_cls['avg_ms']:.2f}ms  success={js_cls['success']}")
    ...
    print(f"TypeScript function: min={ts_ext['min_ms']:.2f}ms  avg={ts_ext['avg_ms']:.2f}ms  success={ts_ext['success']}")
    ...
    print(f"TypeScript interface: min={ts_iface['min_ms']:.2f}ms  avg={ts_iface['avg_ms']:.2f}ms  success={ts_iface['success']}")
    ...
    print(f"Java class:          min={java_cls['min_ms']:.2f}ms  avg={java_cls['avg_ms']:.2f}ms  success={java_cls['success']}")
