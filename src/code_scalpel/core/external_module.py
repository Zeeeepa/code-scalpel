...
from code_scalpel.core.autocommit import commiter, reader
...
from code_scalpel.core.placeholder.placeholder_stub import StubPlaceholder
from code_scalpel.enums import ImportType, NodeType
