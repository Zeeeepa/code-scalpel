...
from code_scalpel.codebase.transactions import EditTransaction, InsertTransaction, RemoveTransaction, TransactionPriority
from code_scalpel.core.autocommit import commiter, reader, remover, repr_func, writer
from code_scalpel.core.placeholder.placeholder import Placeholder
from code_scalpel.extensions.utils import get_all_identifiers
from code_scalpel.output.ast import AST
from code_scalpel.output.constants import ANGULAR_STYLE, MAX_STRING_LENGTH
from code_scalpel.output.jsonable import JSONable
from code_scalpel.output.utils import style_editable
from code_scalpel.utils import descendant_for_byte_range, find_all_descendants, find_first_ancestor, find_index, truncate_line
...
if TYPE_CHECKING:
    ...
    from code_scalpel.codebase.codebase_context import CodebaseContext
    ...
    from code_scalpel.core.dataclasses.usage import UsageKind
    from code_scalpel.core.detached_symbols.function_call import FunctionCall
    from code_scalpel.core.export import Export
    from code_scalpel.core.expressions import Expression
    from code_scalpel.core.expressions.type import Type
    from code_scalpel.core.file import File, SourceFile
    from code_scalpel.core.function import Function
    from code_scalpel.core.import_resolution import Import, WildcardImport
    ...
    from code_scalpel.core.statements.statement import Statement
    from code_scalpel.core.symbol import Symbol
    from code_scalpel.core.symbol_group import SymbolGroup
    from code_scalpel.enums import NodeType
...
class Editable(JSONable, Generic[Parent]):
    ...
    def _add_symbol_usages(self: HasName, identifiers: list[TSNode], usage_type: UsageKind, dest: HasName | None = None) -> None:
        from code_scalpel.core.expressions import Name
        from code_scalpel.core.interfaces.resolvable import Resolvable
