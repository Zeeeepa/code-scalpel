...
from code_scalpel.core.autocommit import reader, writer
...
from code_scalpel.core.interfaces.supports_generic import SupportsGenerics
...
if TYPE_CHECKING:
    ...
    from code_scalpel.core.statements.return_statement import ReturnStatement
