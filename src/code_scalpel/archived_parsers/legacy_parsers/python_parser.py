...
# [20251221_DEPRECATION] DEPRECATED - Use code_scalpel.code_parser.PythonParser
# This is a legacy minimal parser. The new implementation in code_parser/ provides:
# - Structured error handling and metrics
# - Multiple Python parsers (AST, Ruff, Mypy, Flake8, Bandit, etc.)
# - Cyclomatic complexity calculation
# - Detailed parse results with error locations
