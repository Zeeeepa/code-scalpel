...
from code_scalpel.codebase.config_parser import ConfigParser, get_config_parser_for_language
from code_scalpel.codebase.diff_lite import ChangeType, DiffLite
from code_scalpel.codebase.flagging.flags import Flags
from code_scalpel.codebase.io.file_io import FileIO
from code_scalpel.codebase.progress.stub_progress import StubProgress
from code_scalpel.codebase.transaction_manager import TransactionManager
from code_scalpel.codebase.validation import get_edges, post_reset_validation
from code_scalpel.core.autocommit import AutoCommit, commiter
from code_scalpel.core.directory import Directory
from code_scalpel.core.external.dependency_manager import DependencyManager, get_dependency_manager
from code_scalpel.core.external.language_engine import LanguageEngine, get_language_engine
from code_scalpel.enums import Edge, EdgeType, NodeType
from code_scalpel.extensions.sort import sort_editables
from code_scalpel.extensions.utils import uncache_all
from code_scalpel.typescript.external.ts_declassify.ts_declassify import TSDeclassify
...
if TYPE_CHECKING:
    ...
    from code_scalpel.codebase.node_classes.node_classes import NodeClasses
    from code_scalpel.codebase.progress.progress import Progress
    from code_scalpel.core.dataclasses.usage import Usage
    from code_scalpel.core.expressions import Expression
    from code_scalpel.core.external_module import ExternalModule
    from code_scalpel.core.file import File, SourceFile
    from code_scalpel.core.interfaces.importable import Importable
    from code_scalpel.core.node_id_factory import NodeId
    from code_scalpel.core.parser import Parser
...
def get_node_classes(programming_language: ProgrammingLanguage) -> NodeClasses:
    if programming_language == ProgrammingLanguage.PYTHON:
        from code_scalpel.codebase.node_classes.py_node_classes import PyNodeClasses

        return PyNodeClasses
    elif programming_language == ProgrammingLanguage.TYPESCRIPT:
        from code_scalpel.codebase.node_classes.ts_node_classes import TSNodeClasses

        return TSNodeClasses
    else:
        from code_scalpel.codebase.node_classes.generic_node_classes import GenericNodeClasses
        ...
        if self.config.disable_graph:
            ...
            try:
                ...
                if counter[NodeType.SYMBOL] > 0:
                    from code_scalpel.core.interfaces.inherits import Inherits
