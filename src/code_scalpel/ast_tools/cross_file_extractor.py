...
class CrossFileExtractor:
    ...
    def extract_multiple(
        ...
        for file_path, symbol_name in targets:
            ...
            combined_result.depth_reached = max(
                combined_result.depth_reached, 
                single_result.depth_reached
            )
    ...
    def _is_stdlib_module(self, module_name: str) -> bool:
        ...
        stdlib_prefixes = {
            "os", "sys", "io", "re", "json", "math", "random",
            "collections", "itertools", "functools", "typing",
            "pathlib", "datetime", "time", "logging", "warnings",
            "unittest", "pytest", "abc", "contextlib", "dataclasses",
            "enum", "copy", "pickle", "csv", "xml", "html",
            "http", "urllib", "socket", "email", "base64", "hashlib",
            "hmac", "secrets", "threading", "multiprocessing", "subprocess",
            "asyncio", "concurrent", "queue", "sched", "select", "signal",
        }
