...
UNIFIED_SINKS: Dict[str, Dict[str, List[SinkDefinition]]] = {
    ...
    "sql_injection": {
        "python": [
            SinkDefinition("cursor.execute", 1.0, SecuritySink.SQL_QUERY, "Raw SQL execution"),
            SinkDefinition("connection.execute", 1.0, SecuritySink.SQL_QUERY, "Direct connection execute"),
            SinkDefinition("session.execute", 0.95, SecuritySink.SQL_QUERY, "SQLAlchemy session execute"),
            SinkDefinition("engine.execute", 0.95, SecuritySink.SQL_QUERY, "SQLAlchemy engine execute"),
            SinkDefinition("db.execute", 1.0, SecuritySink.SQL_QUERY, "Generic database execute"),
            SinkDefinition("cursor.executemany", 1.0, SecuritySink.SQL_QUERY, "Batch SQL execution"),
            SinkDefinition("RawSQL", 1.0, SecuritySink.SQL_QUERY, "Django raw SQL"),
            SinkDefinition("QuerySet.extra", 0.9, SecuritySink.SQL_QUERY, "Django QuerySet extra"),
            SinkDefinition("sqlalchemy.text", 0.85, SecuritySink.SQL_QUERY, "SQLAlchemy text query"),
        ],
        "java": [
            SinkDefinition("Statement.executeQuery", 1.0, SecuritySink.SQL_QUERY, "JDBC Statement query"),
            SinkDefinition("Statement.executeUpdate", 1.0, SecuritySink.SQL_QUERY, "JDBC Statement update"),
            SinkDefinition("Statement.execute", 1.0, SecuritySink.SQL_QUERY, "JDBC Statement execute"),
            SinkDefinition("PreparedStatement.executeQuery", 0.5, SecuritySink.SQL_QUERY, "PreparedStatement (safer if used correctly)"),
            SinkDefinition("entityManager.createQuery", 0.8, SecuritySink.SQL_QUERY, "JPA JPQL query"),
            SinkDefinition("entityManager.createNativeQuery", 0.9, SecuritySink.SQL_QUERY, "JPA native SQL"),
            SinkDefinition("jdbcTemplate.query", 0.7, SecuritySink.SQL_QUERY, "Spring JdbcTemplate query"),
            SinkDefinition("jdbcTemplate.update", 0.7, SecuritySink.SQL_QUERY, "Spring JdbcTemplate update"),
        ],
        "typescript": [
            SinkDefinition("connection.query", 1.0, SecuritySink.SQL_QUERY, "Direct SQL query"),
            SinkDefinition("pool.query", 1.0, SecuritySink.SQL_QUERY, "Connection pool query"),
            SinkDefinition("knex.raw", 1.0, SecuritySink.SQL_QUERY, "Knex raw SQL"),
            SinkDefinition("knex.whereRaw", 0.95, SecuritySink.SQL_QUERY, "Knex raw where clause"),
            SinkDefinition("sequelize.query", 0.9, SecuritySink.SQL_QUERY, "Sequelize raw query"),
            SinkDefinition("prisma.$queryRaw", 0.9, SecuritySink.SQL_QUERY, "Prisma raw query"),
            SinkDefinition("typeorm.query", 0.9, SecuritySink.SQL_QUERY, "TypeORM raw query"),
        ],
        "javascript": [
            SinkDefinition("db.query", 0.9, SecuritySink.SQL_QUERY, "Generic database query"),
    ...
    "command_injection": {
        ...
        "java": [
            SinkDefinition("Runtime.getRuntime().exec", 1.0, SecuritySink.SHELL_COMMAND, "Runtime exec"),
            SinkDefinition("ProcessBuilder.command", 0.9, SecuritySink.SHELL_COMMAND, "ProcessBuilder command"),
            SinkDefinition("ProcessBuilder.start", 0.9, SecuritySink.SHELL_COMMAND, "ProcessBuilder start"),
        ],
        "typescript": [
            SinkDefinition("child_process.exec", 1.0, SecuritySink.SHELL_COMMAND, "Child process exec"),
            SinkDefinition("child_process.spawn", 0.9, SecuritySink.SHELL_COMMAND, "Child process spawn"),
            SinkDefinition("child_process.execSync", 1.0, SecuritySink.SHELL_COMMAND, "Synchronous exec"),
    ...
    "xss": {
        "typescript": [
            ...
            SinkDefinition("dangerouslySetInnerHTML", 1.0, SecuritySink.DOM_XSS, "React dangerous HTML"),
        ...
        "python": [
            SinkDefinition("render_template_string", 1.0, SecuritySink.SSTI, "Flask template string rendering"),
        ...
        "java": [
            SinkDefinition("response.getWriter().write", 0.8, SecuritySink.HTML_OUTPUT, "Servlet response write"),
            SinkDefinition("PrintWriter.println", 0.7, SecuritySink.HTML_OUTPUT, "PrintWriter output"),
            SinkDefinition("HttpServletResponse.getWriter", 0.75, SecuritySink.HTML_OUTPUT, "Servlet writer"),
        ],
    },
    ...
    "ssrf": {
        ...
        "java": [
            ...
            SinkDefinition("RestTemplate.getForObject", 0.85, SecuritySink.SSRF, "Spring RestTemplate GET"),
            SinkDefinition("RestTemplate.exchange", 0.85, SecuritySink.SSRF, "Spring RestTemplate exchange"),
