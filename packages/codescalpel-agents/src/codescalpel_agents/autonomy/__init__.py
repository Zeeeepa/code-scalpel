...
from codescalpel_agents.autonomy.audit import AuditEntry, AutonomyAuditTrail
...
from codescalpel_agents.autonomy.fix_loop import FixAttempt, FixLoop, FixLoopResult

# [20251217_FEATURE] Mutation Test Gate
from codescalpel_agents.autonomy.mutation_gate import (
    Mutation,
    MutationGateResult,
    MutationResult,
    MutationTestGate,
...
from codescalpel_agents.autonomy.stubs import SandboxResult as StubSandboxResult
