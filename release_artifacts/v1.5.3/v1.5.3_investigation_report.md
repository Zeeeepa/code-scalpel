...
**Key Discovery:** 
- OSV tests pass in isolation: 56/56 ✅
- OSV tests pass with filter (`-k "test_osv"`): 56/56 ✅
- OSV tests fail in full suite: 30 errors ❌
...
56 passed in 6.67s ✅
```
✅ **PASS** - No other test files loaded, module resolution succeeds
...
83 passed in 15.43s ✅
```
✅ **PASS** - Pytest collects only relevant files, module resolution succeeds

**Scenario 3: Full Suite with agents ignored**
```bash
$ pytest tests/ --ignore=tests/test_agents.py -q
18 errors in OSV tests ❌
```
❌ **FAIL** - Full collection triggers resolution issue

**Scenario 4: Full Suite**
```bash
$ pytest tests/ -q
30 OSV-related errors ❌
```
❌ **FAIL** - Full collection with agents
...
def pytest_configure(config):
    ...
    try:
        ...
        print("✓ Pre-loaded osv_client module before test collection")
...
|----------|---------|-----------|
| Isolated: `pytest tests/test_osv_client.py` | 56/56 ✅ | 56/56 ✅ |
| Paired: `pytest tests/test_osv_client.py tests/test_scan_dependencies.py` | 83/83 ✅ | 83/83 ✅ |
| Full Suite: `pytest tests/` | 30 errors ❌ | 2268/2268 ✅ |
| With Filter: `pytest tests/ -k "test_osv"` | 56/56 ✅ | 56/56 ✅ |
...
- ✅ pytest tests/ produces 2268/2268 PASS
- ✅ No workarounds needed in CI/CD
- ✅ Works with Python 3.9-3.13
- ✅ Works with pytest plugins (xdist, cov, etc.)
