...
```
tests/test_osv_client.py: 56 passed [COMPLETE]
tests/test_scan_dependencies.py: 27 passed [COMPLETE]
Combined: 83 tests passed [COMPLETE]
```

### Full Suite Execution
```
Total tests: 2,268 collected
Passing: 2,238 [COMPLETE]
OSV-related: 56 passing [COMPLETE]
